...
export const availabilitySchema = Yup.object({
  serviceId: Yup.string().nullable().default(null),
  ...
  slotDurationMin: Yup.number()
    ...
    .test("five-minute-slot", "Slot duration must use 5-minute increments.", (value) => value % 5 === 0)
  ...
  bufferBeforeMin: Yup.number()
    ...
    .test("five-minute-before", "Buffer must use 5-minute increments.", (value) => value % 5 === 0)
  ...
  bufferAfterMin: Yup.number()
    ...
    .test("five-minute-after", "Buffer must use 5-minute increments.", (value) => value % 5 === 0)
